...
export function HabitDay({
	...
	function handleCommpletedChanged(completed: number) {
	...
	return (
		<Popover.Root>
			...
			/>
			<Popover.Portal>
				<Popover.Content className="min-w-[320px] p-5 rounded-2xl bg-zinc-900 flex flex-col">
					...
					<HabitsList date={date} onCompletedChanged={handleCommpletedChanged} />
